...
models = {
    "AECSS": [
        ...
        ("202203050123_AECSS_arch70", 104, "arch70"),
        # ("202203042153_AECSS_arch66_dcl", 29, "arch66"),
    ]
}
for v, n, a in models["AECSS"]:
    # system(
    #     f"python3 ~/SeqEncoder/SeqEN/SeqEN2/sessions/test_session.py -n AECSS -mv {v} -mid {n} -dclss single_act_clss_test -a {a} -teb -1 -tsne 2 -prids Q8LJW3-F1-model_v1_1,2JOQ -t sample"
    # )
    system(
