...
python3 ./SeqEN2/sessions/train_session.py -n experiment{job_id} {dataset_cl_arg} {dataset_ss_arg} {dataset_clss_arg} {arch} {noise_arg} {nc} {trb_arg} -w 20 -d1 8 -ts params4 -ti 100 -le 1000 {epoch_arg} {mvid_arg}
